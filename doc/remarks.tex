...
\vspace{2em}
\textbf{\large Remarks for Introduction and Abstract:}
\vspace{1em}
\begin{itemize}[leftmargin=10pt]
	\item Check sentence ''applying fewer conditional calls'' in Intro
	\item Rewrite Abstract, not as a structure overview but as with content of paper in structured way, by using important sentences of each section
\end{itemize}
